#!/usr/bin/env python3
"""
Direct test script for SecAudit Configuration System
Tests configuration components directly without problematic imports
"""
...
def test_configuration_direct():
    """Test the configuration system components directly"""
    print("Testing SecAudit Configuration System (Direct)")
    print("=" * 50)
    
    # Test 1: Import configuration classes directly
    try:
...
if __name__ == "__main__":
    success = test_configuration_direct()
