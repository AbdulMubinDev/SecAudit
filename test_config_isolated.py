#!/usr/bin/env python3
"""
Isolated test script for SecAudit Configuration System
Tests configuration components by importing them directly
"""
...
def test_configuration_isolated():
    """Test the configuration system components in isolation"""
    print("Testing SecAudit Configuration System (Isolated)")
    print("=" * 50)
    
    # Test 1: Import configuration classes directly from module
    try:
        from secaudit.core.config import SecAuditConfig, ConfigManager, load_config
...
if __name__ == "__main__":
    success = test_configuration_isolated()
